...
export const ImplementasiProses = () => {
  const prosesImages = [
    {
  ...
  const totalSlides = prosesImages.length;

  return (
    <section id="implementasiproses" className="py-20 bg-gray-50 shadow-lg">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="relative bg-white rounded-2xl shadow-lg overflow-hidden">
          <div className="relative h-96">
            <img
              src={prosesImages[currentSlide].gambar}
              alt={prosesImages[currentSlide].title}
              className="w-full h-full object-cover brightness-75"
            />
            <div className="absolute inset-0 flex items-center justify-center">
              <div className="text-center text-white">
                <h3 className="text-2xl font-bold mb-2">
                  {prosesImages[currentSlide].title}
                </h3>
                <p className="text-lg opacity-90 max-w-md mx-auto">
                  {prosesImages[currentSlide].description}
                </p>
              </div>
            </div>
          </div>
