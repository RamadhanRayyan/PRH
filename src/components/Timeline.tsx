  ...
  return (
    <section className="bg-gradient-to-b from-blue-100 to-white py-16 relative">
      <div className="max-w-7xl mx-auto px-6">
        ...
        <button
          onClick={scrollLeft}
          className="absolute left-10 top-1/2 transform -translate-y-1/2 bg-blue-500 text-white p-3 rounded-full shadow-lg hover:bg-blue-600"
        >
          <ChevronLeft size={24} />
        </button>
        ...
        <button
          onClick={scrollRight}
          className="absolute right-10 top-1/2 transform -translate-y-1/2 bg-blue-500 text-white p-3 rounded-full shadow-lg hover:bg-blue-600"
        >
        ...
        <div
          ref={scrollRef}
          className="flex gap-8 overflow-x-hidden scrollbar-hide scroll-smooth"
        >
          {timelineData.map((item, index) => (
            <div
              key={index}
              className="min-w-[300px] bg-white rounded-2xl shadow-md p-6 border-t-4 border-blue-500 flex-shrink-0"
            >
