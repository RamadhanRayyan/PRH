    ...
    <section id="kontak" className="py-20 bg-gray-50">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="bg-gradient-to-br from-blue-50 to-teal-50 rounded-2xl p-8">
          ...
          {/* Baris Social Media */}
          <div className="flex flex-col md:flex-row justify-center items-center gap-16 mb-10 text-center">
            {/* Instagram */}
            <a
              href="https://www.instagram.com/rekayasanusamandiri"
              target="_blank"
              rel="noopener noreferrer"
              className="flex-1 flex items-start space-x-4 hover:scale-105 transition-transform"
            >
        ...
        <div className="fixed bottom-6 right-6 z-50">
          ...
          >
            ...
            <span
              ...
              style={{ animation: "pulseWave 1.5s ease-in-out infinite" }}
            ></span>
          </a>
